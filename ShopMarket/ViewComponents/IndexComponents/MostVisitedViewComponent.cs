...
{
    public class MostVisitedViewComponent : ViewComponent
    {
        private readonly IProductService _productService;
        private readonly IProductImageService _imageService;

        public MostVisitedViewComponent(IProductService productService, IProductImageService imageService)
        {
        ...
        {
            var products = _productService.GetMostVisitedProducts().ToList();
