...
namespace ShopMarket.ViewComponents
{
    public class CartPreviewViewComponent : ViewComponent
    {
        ...
        public CartPreviewViewComponent(IOrderService orderService, IOrderItemService orderItemService, IProductImageService imageService, IStoreRepository storeRepository)
        {
